                      ...
                      builder: (context) {
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ...
                            FilledButton(child: const Text("OK"), onPressed: () => Navigator.pop(context, tempSelected)),
                          ],
                        );
                      },
                    );
                  ...
                  child: Container(
                    ...
                    child: muscleIds.isEmpty
                        ...
                        : Wrap(
                            ...
                            children: muscleIds
                                .map(
                                  (id) => muscles.firstWhere(
                                    (m) => m.id == id,
                                    orElse: () => throw Exception('Muscle not found'),
                                  ),
                                )
                                .map(
                                  (m) => InputChip(
                    ...
                    FilledButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState?.validate() ?? false) {
                          ...
                          widget.onComplete(
                            newExercise,
                            [...muscleIds].map((mid) => muscles.firstWhere((m) => m.id == mid)).toList(),
                          );
