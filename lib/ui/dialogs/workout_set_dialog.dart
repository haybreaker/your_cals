...
class WorkoutSetDialog extends StatefulWidget {
  ...
  const WorkoutSetDialog({super.key, required this.workoutSet, required this.rep, required this.onCompleted});
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: 'Reps', border: OutlineInputBorder(), filled: true),
                  validator: (val) {
                    if (val == null || val.isEmpty) return 'Required';
