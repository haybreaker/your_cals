...
import 'package:your_cals/data/objects/exercise.dart';
import 'package:your_cals/data/objects/muscle.dart';
import 'package:your_cals/data/objects/rep.dart';
import 'package:your_cals/data/objects/set.dart' as exercise_set;
...
import 'package:your_cals/ui/dialogs/exercise_dialog.dart';
import 'package:your_cals/ui/dialogs/workout_set_dialog.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              if (exercise.notes != null && exercise.notes!.isNotEmpty) ...[
                ...
                Text(exercise.notes!, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                const SizedBox(height: 16),
              ],
              Card(
                elevation: 1,
              ...
              TableCalendar(
                ...
                calendarStyle: CalendarStyle(
                  ...
                  selectedDecoration: BoxDecoration(
                    color: theme.colorScheme.primary.withAlpha((255 / 2).toInt()),
...
class WorkoutSetCard extends StatelessWidget {
  ...
  const WorkoutSetCard({super.key, required this.workoutSet, required this.rep});
