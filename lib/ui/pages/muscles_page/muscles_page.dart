...
import 'package:your_cals/ui/pages/muscles_page/new_muscle_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: InkWell(
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        title: Text(muscle.name, style: Theme.of(context).textTheme.titleMedium),
                        subtitle: Text(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          final newMuscle = await showDialog(context: context, builder: (context) => const MuscleDialog());
          if (newMuscle != null) {
