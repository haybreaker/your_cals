...
class _UserSetupPageState extends State<UserSetupPage> {
  ...
  final List<String> _trainingGoals = ['Strength', 'Hypertrophy', 'Endurance', 'General Fitness', 'Weight Loss'];
            ...
            child: ListView(
              children: [
                ...
                DropdownButtonFormField<String>(
                  decoration: const InputDecoration(labelText: 'Training Goal', border: OutlineInputBorder()),
                  value: _trainingGoal,
                ...
                const SizedBox(height: 24),
                FilledButton(onPressed: _submit, child: const Text('Create Profile')),
              ],
            ),
          ),
        ),
